...
export default function HeroSection() {
    ...
    return (
        <section className="w-full h-dvh flex flex-col items-center relative">
            ...
            <div className="rounded-full top-5 -right-5 w-56 h-56 bg-primary absolute z-0"></div>
            {/* <div className="rounded-full w-96 h-96 bg-secondary opacity-40 blur-2xl absolute"></div> */}
        </section>
    );
}  
